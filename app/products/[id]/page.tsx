        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-12 w-10/12 2xl:w-9/12 items-center">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex justify-center items-center gap-4 transition ease-in-out duration-150">
              <button disabled={false} className='text-stone-50 bg-gray-700 w-full p-2 rounded-md font-semibold cursor-pointer disabled:bg-gray-400 disabled:text-gray-600 disabled:cursor-not-allowed'>Editar</button>
            </div>
          </div>
        </div>
      </main>
