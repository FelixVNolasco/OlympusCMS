...
const getAllUsers = () => {
  return fetch("https://olympus-backend.vercel.app/api/users/", { cache: "no-store", headers: { token: `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYzYzBlMmVjODc3MmMwYTQ0YmIwMTQxNiIsImlzQWRtaW4iOnRydWUsImlhdCI6MTY3NDIzOTA1NSwiZXhwIjoxNjc0NDk4MjU1fQ.9fWAo7ltTi_nQk6dkbFA_cQEm6YSW2BLW3il0tZZBb4` } })
    .then((res) => res.json())
}
