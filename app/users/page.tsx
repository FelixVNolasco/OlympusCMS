...
const getAllUsers = () => {
  return fetch("https://olympus-backend.vercel.app/api/users/", { cache: "no-store", headers: { token: `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYzYzBlMmVjODc3MmMwYTQ0YmIwMTQxNiIsImlzQWRtaW4iOnRydWUsImlhdCI6MTY3MzU4NTU2MCwiZXhwIjoxNjczODQ0NzYwfQ.M3EIq2l20AZyWkNzNDYkqAyFVaQq_KwM2QH0rSNN53E` } })
    .then((res) => res.json())
}
